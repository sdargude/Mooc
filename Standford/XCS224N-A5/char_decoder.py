...
class CharDecoder(nn.Module):
    def __init__(self, hidden_size, char_embedding_size=50, target_vocab=None):
        ...
        self.decoderCharEmb = nn.Embedding(len(self.target_vocab.char2id),
                                           self.char_embedding_size, self.padding_idx)
    ...
    def forward(self, input, dec_hidden=None):
        ...
        s = self.char_output_projection(hidden_states)
        return s, dec_hidden
        ### END YOUR CODE
    ...
    def train_forward(self, char_sequence, dec_hidden=None):
        ...
        # loss = loss(scores, char_sequence[1:].transpose(1,0))
        loss = loss(scores, char_sequence[1:])
        return loss
        ### END YOUR CODE
